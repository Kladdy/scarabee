...
nuclides = [
    ...
    Nuclide("Ag", 47, 107),
    Nuclide("Ag", 47, 109),
    Nuclide("Ag", 47, 110, metastable_state=1),
    Nuclide("Ag", 47, 111),
    Nuclide("Cd", 48, 106),
    Nuclide("Cd", 48, 108),
    Nuclide("Cd", 48, 110),
    ...
    Nuclide("Te", 52, 127, is_fission_product=True, metastable_state=1),
    Nuclide("Te", 52, 129, is_fission_product=True, metastable_state=1),
    ...
    Nuclide("Pm", 61, 148, is_fission_product=True, metastable_state=1),
    ...
    Nuclide("Pu", 94, 244),
    Nuclide("Am", 95, 241),
    Nuclide("Am", 95, 242, metastable_state=1),
    Nuclide("Am", 95, 243),
    Nuclide("Cm", 96, 242),
    Nuclide("Cm", 96, 243),
    Nuclide("Cm", 96, 244),
