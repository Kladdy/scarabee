...
UO2xs = CrossSection(Et, Ea, Es, Ef, nu*Ef, chi, name="UO2")
...
M4xs = CrossSection(Et, Ea, Es, Ef, nu*Ef, chi, name="MOX 4.3%")
...
M7xs = CrossSection(Et, Ea, Es, Ef, nu*Ef, chi, name="MOX 7.0%")
...
M8xs = CrossSection(Et, Ea, Es, Ef, nu*Ef, chi, name="MOX 8.7%")
...
H2Oxs = CrossSection(Et, Ea, Es, name="Water")
...
FCxs = CrossSection(Et, Ea, Es, name="Fission Chamber")
...
GTxs = CrossSection(Et, Ea, Es, name="Guide Tube")
